...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $no_referensi = $tanggal_format . "_SET_" . $urutan;

    // Menambahkan transaksi setoran ke tabel transaksi
    $sql = "INSERT INTO transaksi (id_siswa, jumlah, jenis_transaksi, tanggal, waktu, no_referensi) VALUES (?, ?, 'setor', ?, NOW(), ?)";
    ...
    if ($stmt->execute()) {
        ...
        $message = "Gagal menambahkan setoran.";
    }
}
?>
...
<head>
    ...
    <title>Form Setoran | Dashboard Admin</title>
